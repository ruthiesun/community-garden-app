...
/**
 * Displays and handles the oracle/app database login GUI.
 * SOURCE: https://github.students.cs.ubc.ca/CPSC304/CPSC304_Java_Project/blob/master/src/ca/ubc/cs304/ui/LoginWindow.java
 */
    ...
    public void showFrame(LoginWindowDelegate delegate) {
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                delegate.loginToUser(usernameField.getText(), String.valueOf(passwordField.getPassword()));
            }
        });
